...
*   **Masonry Image Feed:** The home screen features a dynamic, Pinterest-style staggered grid. Notes with images automatically extract the dominant color and display stunning edge-to-edge thumbnails.
*   **Checklists & Tasks:** Convert any text note into an interactive checklist with drag-to-reorder support.
*   **Organization:** Color-code your notes, attach custom labels, and pin important items to the top.
...
2.  Clone this repository:
    ```bash
    git clone https://github.com/confusedmulga/Coala.git
    ```
3.  Navigate to the project directory and fetch dependencies:
    ```bash
    cd Coala
    flutter pub get
    ```
